    ...
    <div>
        <form  method="post"  id="${entityName}Fm">
            ...
            <table cellpadding="5">
                ...
                <tr>
                    <td>
                        <a class="easyui-linkbutton c6" iconCls="icon-save" style="width:120px;height: 36px;" onclick="saveEntity('${entityName}','${req.contextPath}','${indexTitle}','${indexIconCls}','${titleName}');"><@spring.message "save"/></a>
                    </td>
                    <td>
