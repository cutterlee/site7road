...
<div class="easyui-panel" style="height: 100%;width: auto;">
...
<table id="${entityName}grid" class="easyui-datagrid" style="width:100%;height:88%"
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'lastLoginTime',formatter:function(value){return formateGridDate(value);}"  width="100"><@spring.message "user.last.login.time"/></th>
            ...
            <th  data-options="field:'createTime',formatter:function(value){return formateGridDate(value);}" width="100"><@spring.message "user.create.time"/></th>
    </tr>
    </thead>
</table>
