...
<table id="${entityName}grid" class="easyui-datagrid" style="width:100%;height:100%"
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'lastLoginTime',formatter:function(value){return formateGridDate(value);}"  width="100">最后登录时间</th>
            ...
            <th  data-options="field:'createTime',formatter:function(value){return formateGridDate(value);}" width="100">创建时间</th>
    </tr>
    </thead>
</table>
